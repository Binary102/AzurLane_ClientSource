...
function slot0.init(slot0)
	...
	LoadSpriteAsync("battlescore/" .. ((slot0.contextData.score <= 0 or ({
		"grade_label_d",
		"grade_label_over_time",
		"grade_label_b",
		"grade_label_a",
		"grade_label_s"
	})[slot3 + 1]) and ((slot0.contextData.statistics._scoreMark == ys.Battle.BattleConst.DEAD_FLAG and "grade_label_flag_destroy") or "grade_label_team_kill")), function (slot0)
		setImageSprite(slot0._gradeLabel, slot0, true)

		slot0._gradeLabel.pivot = Vector2(0.5, 0.5)

		setAnchoredPosition(slot0._gradeLabel, Vector3.zero)
...
function slot0.didEnter(slot0)
	...
	slot1.localPosition = Vector3(0, 15, 0)
...
function slot0.displayBG(slot0)
	...
	LeanTween.moveLocal(go(slot0._gradeLabel), Vector3(slot0._gradeLabel.rect.width * 0.5, 0, 0), slot0.DURATION_MOVE)
