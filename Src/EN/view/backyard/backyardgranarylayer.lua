...
function slot0.updateFood(slot0, slot1)
	...
	setText(slot0:findTF("name_bg/Text", slot2), (slot1.count ~= 0 or setColorStr(pg.item_data_statistics[slot1.id].name, "#2f2d2b")) and setColorStr(pg.item_data_statistics[slot1.id].name, "#4E3E42FF"))
