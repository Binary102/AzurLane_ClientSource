return {
	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				{
					"<size=34>只要伸手 总有一天终能触及</size>",
					2
				},
				{
					"<size=34>始于纯白无际之处的「奇点」</size>",
					4
				},
				{
					"<size=34>孕育出本不应存在的「羁绊」</size>",
					6
				},
				{
					"<size=34>那是 诞生于这片纯白之人</size> ",
					8
				},
				{
					"<size=34>与 苍蓝行星孕育出的生命之间的誓约</size>",
					10
				},
				{
					" ",
