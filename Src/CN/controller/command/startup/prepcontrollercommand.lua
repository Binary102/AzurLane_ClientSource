class("PrepControllerCommand", pm.SimpleCommand).execute = function (slot0, slot1)
	...
	slot0.facade:registerCommand(GAME.FETCH_CHALLENGE, FetchChallengeCommand)
	slot0.facade:registerCommand(GAME.CHALLENGE_REQUEST, ChallengeRequestCommand)
	slot0.facade:registerCommand(GAME.CHALLENGE_RESET, ChallengeResetCommand)
	slot0.facade:registerCommand(GAME.CHALLENGE_STRATEGY, ChallengeStrategyCommand)
	slot0.facade:registerCommand(GAME.FETCH_CHALLENGE, FetchChallengeCommand)
	...
	slot0.facade:registerCommand(GAME.GET_PLAYERPOWERRANK, GetPlayerPowerRankCommand)
