	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>「なんでもわかってくれる人」</size>",
					1.5
				},
				{
					"<size=34>「そうね。あなたの話を聞いてくれるだけでなく」</size>",
					3
				},
				{
					"<size=34>「あなたの本当に思っていることを当ててくれる人がいれば、」</size>",
					4.5
				},
				{
					"<size=34>「ひとりぼっちだなんて、とても言えなくなるんじゃない？ふふふ」</size>",
					6.5
				}
			}
		},
