	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>\"나타난 모든 적을 파괴하면 평화가 돌아올 거라고 생각하고 있었다.\"</size>",
					2.5
				},
				{
					"<size=34>\"하지만 세계의 ‘미래’는… 우리를 배신했다.\"</size>",
					5
				},
				{
					"<size=34>\"날개가 부러지고, 포신이 녹고, 우리 몸을 이루는 강철이 삐꺽이지만, 싸움은 끝나지 않는다.\"</size>",
					7
				},
				{
					"<size=34>\"하나 둘씩 사라져 간, 앞서 떠난 동료들……이젠 그 얼굴조차 잊어버렸다.\"</size> ",
					10
				},
				{
					"<size=34>\"…출격, 인가\"</size>",
				...
				{
					"<size=34>\"…오늘도 하늘이 아름답군.\"</size>",
					15
				},
				{
					"<size=34>어둠에 떨어진 푸른 날개</size>",
					20
				}
			}
		},
