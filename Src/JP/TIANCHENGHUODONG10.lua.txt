	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=34>変化に適応したものだけが生き延びる。</size>",
					4
				},
				{
					"<size=34>弱き者は淘汰されるが運命。</size> ",
					6
				},
				{
					"<size=34>弱さ故に滅される。それだけだ。</size>",
					8
				},
				{
					"<size=34>ならばせめて、己が全力を尽くして戦場で散るのが私の望み。</size>",
					10
				},
				{
					"<size=34>「連合艦隊、そして重桜のことは頼む――」</size>",
					12
				},
				{
					"<size=34>「私の…………」</size>",
