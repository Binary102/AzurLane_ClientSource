...
function slot0.Preload(slot0)
	...
	if slot0.contextData.system == SYSTEM_DEBUG then
		...
		if slot0.contextData.system == SYSTEM_SCENARIO then
			...
			slot9 = _.detect(slot6.fleets, function (slot0)
			...
			slot10, slot13 = slot6:getFleetBattleBuffs(slot7)

			for slot15, slot16 in ipairs(slot11) do
				for slot21, slot22 in ipairs(slot17) do
					slot1:AddPreloadResource(slot22)
				end
			end
			...
			if slot9 then
				...
				slot13, slot16 = slot6:getFleetBattleBuffs(slot9)

				for slot18, slot19 in ipairs(slot14) do
					for slot24, slot25 in ipairs(slot20) do
						slot1:AddPreloadResource(slot25)
					end
				end
			end
