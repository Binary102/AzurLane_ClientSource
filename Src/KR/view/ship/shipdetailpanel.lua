...
function slot0.updateShipAttrs(slot0)
	...
	for slot10, slot11 in pairs(slot0) do
		...
		setText(slot15, "+" .. math.floor(((slot4[slot11] or 0) + (slot3[slot11] or 0)) * (slot5[slot11] or 1)) - (slot3[slot11] or 0))
		setActive(slot15, setActive((slot15 + (slot3[slot11] or 0)) * (slot5[slot11] or 1)) - (slot3[slot11] or 0) ~= 0)
...
function slot0.doAttrAnim(slot0, slot1, slot2, slot3)
	...
	for slot16, slot17 in pairs(slot1) do
		...
		slot26, slot27 = nil
		slot26 = math.floor(((slot5[slot17] or 0) + (slot4[slot17] or 0)) * (slot6[slot17] or 1)) - (slot4[slot17] or 0)
