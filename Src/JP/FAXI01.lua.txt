	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>ーー光のあるところに影あり</size>",
					2.5
				},
				{
					"<size=34>我が祖国の文明が続いて数千年、輝かしき時代の裏には戦争という影が潜む</size>",
					5
				},
				{
					"<size=34>ヘイスティングスから百年戦争、トラファルガーからワーテルロ、</size>",
					7.5
				},
				{
					"<size=34>形こそ、石工から刀剣、そして大砲へと変われども……</size>",
					10
				},
				{
					"<size=34>理想のぶつかり合いが散らす激情の火花がどんなに眩しかろうと、</size>",
					12.5
				},
				{
					"<size=34>犠牲と恐怖の影を落とすのもまた人間の理。</size>",
					15
				}
			}
		},
		{
			...
			sequence = {
				{
					"<size=34>されど影の中にいるからこそ、</size>",
					0.5
				},
				{
					"<size=34>水天の蒼を照らす至高なる存在をより一層感じることができよう。</size>",
					3
				},
				{
					"<size=34>暗闇の中で人を光へと導く、文明が作りし神性の結晶よ、</size>",
					5.5
				},
				{
					"<size=34>御身が指し示すは我が栄光、我が意志、我が旗の往く道先。</size>",
					8
				},
				{
					"<size=34>この命、篤信を果たす聖戦に捧げることにならん。</size>",
					10.5
				},
				{
					"<size=34>自由を顕す、御身の輝きに誓って――</size>",
					13
				}
			}
		},
