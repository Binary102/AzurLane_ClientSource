...
pg.commander_skill_template = {
	...
	[40011] = {
		...
		desc = {
			{
				1,
				"依据指挥喵指挥、后勤属性，提高所在舰队中潜艇的雷击属性(效果小)"
			},
			{
				2,
				"狩猎范围等级+1(Lv2生效)"
	...
	[41021] = {
		...
		desc = {
			{
				1,
				"作为参谋位指挥喵时，依据指挥喵指挥属性，提高所在舰队中潜艇的雷击属性(效果小)"
			},
			{
				2,
				"作为参谋位指挥喵时，依据指挥喵指挥属性，提高所在舰队中潜艇的命中属性(效果中)(Lv2生效)"
			},
			{
				3,
				"狩猎范围等级+1(Lv3生效)"
	...
	[41022] = {
		...
		desc = {
			...
			{
				2,
				"作为参谋位指挥喵时，依据指挥喵指挥属性，提高所在舰队中潜艇的命中属性(效果中)"
			},
			{
				3,
				"狩猎范围等级+1(Lv3生效)"
