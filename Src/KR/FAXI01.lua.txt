	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>在我们数千年的光鲜文明背后，战争一直作为影子伴随着每一次时代的变迁</size>",
					2.5
				},
				{
					"<size=34>从黑斯廷斯到百年战争…</size>",
					5
				},
				{
					"<size=34>从特拉法尔加到滑铁卢…</size>",
					7.5
				},
				{
					"<size=34>战争的形式一直在变，从最早的石器刀枪，到现在的大舰巨炮…</size> ",
					10
				},
				{
					"<size=34>每一次理想的碰撞，总会伴随着巨大的牺牲与恐慌</size>",
					12.5
				}
			}
		},
		{
			...
			sequence = {
				{
					"<size=34>然而，有影必有光</size>",
					0.5
				},
				{
					"<size=34>正是在这样的阴影之中，我们才能得以看清那最闪耀的星光…</size>",
					3
				},
				{
					"<size=34>那些带领人民争取自由，在黑暗中前行的…熟悉的名字，他们正是人类文明的瑰宝</size>",
					5.5
				},
				{
					"<size=34>他们是属于我的荣耀，属于我的信仰</size>",
					8
				},
				{
					"<size=34>而我，将铭刻这份信仰战斗到最后一刻</size>",
					10.5
				},
				{
					"<size=34>在名为自由的光芒之下。</size>",
					13
				}
			}
		},
