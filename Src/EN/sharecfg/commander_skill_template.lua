...
pg.commander_skill_template = {
	...
	[10021] = {
		...
		desc = {
			...
			{
				2,
				"若所在舰队旗舰为战列、战巡或航战，依据指挥喵指挥属性，降低旗舰受到的伤害(Lv2生效)"
			},
			{
				3,
	...
	[10022] = {
		...
		desc = {
			...
			{
				2,
				"若所在舰队旗舰为战列、战巡或航战，依据指挥喵指挥属性，降低旗舰受到的伤害"
			},
			{
				3,
				"依据指挥喵指挥属性，提高所在舰队中战列、战巡、航战的机动、防空属性(效果中)(Lv3生效)"
	...
	[40021] = {
		...
		desc = {
			...
			{
				2,
				"作为参谋位指挥喵，当接触非旗舰敌方单位时，有15%的概率发射一次主炮打击（地图），伤害依据指挥喵指挥属性、双方等级、战斗力决定(Lv2生效)"
			},
			{
				3,
	...
	[40022] = {
		...
		desc = {
			...
			{
				2,
				"作为参谋位指挥喵，当接触非旗舰敌方单位时，有15%的概率发射一次主炮打击（地图），伤害依据指挥喵指挥属性、双方等级、战斗力决定"
			},
			{
				3,
				"作为参谋位指挥喵，与主力舰队交战时，依据指挥喵后勤属性，降低队伍中战列、战巡、航战受到的伤害(Lv3生效)"
