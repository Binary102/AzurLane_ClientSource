...
function slot0.init(slot0)
	...
	slot0.emptySign = slot0:findTF("equipment_empty")
	slot0.emptySignText = slot0:findTF("Text", slot0.emptySign)
end
...
function slot0.filterTasks(slot0, slot1)
	...
	if #slot0.taskVOs <= 0 then
		setActive(slot0.emptySign, true)

		if slot1 == "activity" then
			setText(slot0.emptySignText, pg.gametip.task_empty_tip_2.tip)
		else
			setText(slot0.emptySignText, pg.gametip.task_empty_tip_1.tip)
		end
	else
