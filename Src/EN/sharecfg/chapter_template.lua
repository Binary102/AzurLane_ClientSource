...
pg.chapter_template = {
	...
	[1190017] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "Only those who have conquered the sea may take on the Arctic Sea's final challenge. May the Goddess of War be with you.",
		difficulty = 10,
		avoid_ratio = 15,
		star_require_2 = 4,
		time = 43200,
