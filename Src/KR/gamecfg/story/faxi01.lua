	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>……빛이 있는 곳에 그림자 있으리.</size>",
					2.5
				},
				{
					"<size=34>우리 조국의 문명이 이어진 지 수천 년, 빛나는 시대의 뒷면에는 전쟁이라는 그림자가 서려 있었다.</size>",
					5
				},
				{
					"<size=34>\"헤이스팅스\"에서 \"백년전쟁\", \"트라팔가르\"에서 \"워털루\", </size>",
					7.5
				},
				{
					"<size=34>석기에서 도검, 그리고 대포로 형태가 변할지언정……</size>",
					10
				},
				{
					"<size=34>이상이 서로 부딪치며 흩뿌리는 격정의 불꽃이 아무리 눈부실지라도, </size>",
					12.5
				},
				{
					"<size=34>희생과 공포의 그림자를 드리우는 것 또한 인간의 섭리.</size>",
					15
				}
			}
		},
		{
			...
			sequence = {
				{
					"<size=34>하지만 그림자 안에 있기에, </size>",
					0.5
				},
				{
					"<size=34>물과 하늘의 푸르름을 밝히는 지고의 존재를 한층 더 실감할 수 있을 터.</size>",
					3
				},
				{
					"<size=34>어둠 속에서 사람을 빛으로 인도하는, 문명이 만든 신성의 결정이여, </size>",
					5.5
				},
				{
					"<size=34>당신께서 가리키시는 것은 우리의 영광, 우리의 의지, 우리의 깃발이 향하는 길.</size>",
					8
				},
				{
					"<size=34>이 목숨, 신념을 다할 성전에 바치리.</size>",
					10.5
				},
				{
					"<size=34>자유를 밝히는, 당신의 빛에 맹세코……</size>",
					13
				}
			}
		},
