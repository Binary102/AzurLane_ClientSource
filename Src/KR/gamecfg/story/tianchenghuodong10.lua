	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=34>변화에 적응하는 것만이 살아남을 수 있다는 걸.</size>",
					4
				},
				{
					"<size=34>약자는 도태되는 운명.</size> ",
					6
				},
				{
					"<size=34>약하면 죽는다, 단지 그것뿐.</size>",
					8
				},
				{
					"<size=34>그렇다면 적어도, 전력을 다할 전장에서 끝나는 게 나의 희망사항.</size>",
					10
				},
				{
					"<size=34>\"연합 함대, 그리고 사쿠라 엠파이어를 부탁해……\"</size>",
					12
				},
				{
					"<size=34>\"나의…………\"</size>",
