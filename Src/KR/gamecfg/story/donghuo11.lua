	...
	scripts = {
		...
		},
		{
			...
			sequence = {
				...
				{
					"<size=34>\"인간이란, 왜소한 존재다.\"</size>",
					4.5
				},
				{
					"<size=34>\"그러나, 이런 왜소한 신체에도 커다란 이상이 존재한다.\"</size>",
					7
				},
				{
					"<size=34>\"원하는 자신이 되도록, 노력하고 연구하며 계속 진보해 나가는 것…\"</size>",
					9
				},
				{
					"<size=34>\"원하는 자신이 될 수 없다면, 그것을 형태를 갖춘 존재에게 소망을 위탁하고, 긍지를 지켜나간다.\"</size> ",
					12
				},
				{
					"<size=34>\"그렇기 때문에 인간은 옳은 길을 계속 나아갈 수 있다.\"</size>",
					14.5
				}
			}
		},
		{
			...
			sequence = {
				{
					"<size=34>\"하지만 만약, 우리가 자부심을 버리고, 존귀한 이상과 정반대의 길을 선택했을 때……\"</size>",
					2.5
				},
				{
					"<size=34>\"당신은…\"</size>",
				...
				{
					"<size=34>\"그 잘못된 '미래'를 바로잡아 줄 것인가…?\"</size>",
					7
				}
			}
		}
