...
function pg.ShareMgr.Share(slot0, slot1)
	...
	setText(slot0.decks[slot9].Find(slot0.decks, "server"), i18n("server_name") .. slot7)
	...
	if (1.7777777777777777 >= Screen.width / Screen.height or ScreenShooter.New(math.floor(Screen.height * slot11), Screen.height, TextureFormat.ARGB32)) and ScreenShooter.New(Screen.width, math.floor(Screen.width / slot11), TextureFormat.ARGB32):Take(slot9, slot0.screenshot) then
