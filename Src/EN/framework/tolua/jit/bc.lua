...
return {
	line = function (slot0, slot1, slot2)
		...
		slot11 = slot1(slot4, 7)("%04d %s %-6s %3s ", slot1, slot2 or "  ", slot3(slot4, 6 * slot1(slot3, 255) + 1, 6 * slot1(slot3, 255) + 6), (slot5 == 0 and "") or slot1(slot2(slot3, 8), 255))
