...
function slot6(slot0)
	...
	slot4 = slot1:getConfig("config_id")

	setActive(slot3.get1, slot1.data1 >= 3)
	setActive(slot3.get2, slot1.data1 >= 5)
	setActive(slot3.get3, slot4 <= slot1.data1)
...
function slot6(slot0, slot1, slot2)
	...
	if slot7 <= slot8 then
		slot9 = slot0
		slot8 = slot0.setSpriteTo
		slot10 = "animation/bb_icon/rank"
		slot11 = slot7
		slot10 = slot10 .. slot11
		slot11 = slot6
	...
	if slot7 <= slot9 then
		...
		slot10 = slot9
		slot9 = slot9.setOnUpdate
		slot11 = System
		slot11 = slot11.Action_float
