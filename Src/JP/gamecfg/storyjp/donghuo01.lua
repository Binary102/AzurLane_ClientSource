	...
	scripts = {
		{
			...
			sequence = {
				{
					"<size=34>「現れたすべての敵を破壊すれば、平穏が戻ってくると思っていた」</size>",
					2.5
				},
				{
					"<size=34>「だが世界の『未来』は…私たちを裏切った」</size>",
					5
				},
				{
					"<size=34>「翼が折れ、砲身が熔け、我が身となる鋼が軋んでも、戦いは終わらない」</size>",
					7
				},
				{
					"<size=34>「次々と消えていく前に立ってくれた仲間たち……その顔すら忘れてしまった」</size> ",
					10
				},
				{
					"<size=34>「――出撃、か」</size>",
				...
				{
					"<size=34>「……今夜の空も綺麗だ」</size>",
					15
				},
				{
					"<size=34>——闇に堕ちた青き翼</size>",
					20
				}
			}
		},
