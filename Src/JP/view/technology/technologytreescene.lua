		...
		if #pg.fleet_tech_ship_class[slot1[slot0 + 1]].ships > 5 then
			...
			onButton(slot0, slot6, function ()
				if slot1.rowHeight[1] < GetComponent(slot0, "LayoutElement").preferredHeight then
					...
					GetComponent(slot1:findTF(slot0, slot1.rightContainer), "LayoutElement").preferredHeight = slot1.rowHeight[math.floor((#pg.fleet_tech_ship_class[slot1.findTF(slot0, slot1.rightContainer)].ships - 1) / slot1.countInEveryRow) + 1]
