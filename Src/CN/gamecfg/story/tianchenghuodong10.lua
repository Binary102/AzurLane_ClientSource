	...
	scripts = {
		{
			...
			sequence = {
				...
				{
					"<size=34>物竞天择,适者生存</size>",
					4
				},
				{
					"<size=34>弱者被淘汰是必然的下场</size> ",
					6
				},
				{
					"<size=34>太弱了,才会死,仅此而已</size>",
					8
				},
				{
					"<size=34>既然都是一样的下场,不如在战场上奋战至死</size>",
					10
				},
				{
					"<size=34>联合舰队和重樱的未来就拜托你了——</size>",
					12
				},
				{
					"<size=34>我一生的对手哟</size>",
					14
				}
			}
		},
