...
function slot0.init(slot0)
	...
	slot0.labelName = ScrollTxt.New(findTF(slot0.head, "icon_bg/name_mask"), findTF(slot0.head, "icon_bg/name_mask/name"))
...
function slot0.flushShip(slot0)
	...
	slot0.labelName:setText(slot0.shipGroup:getName(slot0.showTrans))
