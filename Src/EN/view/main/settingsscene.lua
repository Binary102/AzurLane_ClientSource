...
function slot0.init(slot0)
	...
	slot0:initTransCodePanel(slot0:findTF("main/account"))
end
...
function slot0.initTransCodePanel(slot0, slot1)
	...
	slot0.accountTwitterUI = slot0:findTF("account_twitter", slot1)
	slot0.goTranscodeUIBtn = slot0:findTF("transcode_btn", slot0.accountTwitterUI)
	slot0.twitterBtn = slot0:findTF("twitter_btn", slot0.accountTwitterUI)
	slot0.twitterUnlinkBtn = slot0:findTF("twitter_unlink_btn", slot0.accountTwitterUI)
	slot0.twitterLinkSign = slot0:findTF("title_desc", slot0.accountTwitterUI)
...
function slot0.checkAccountFacebookView(slot0)
	...
	setActive(slot0.facebookUnlinkBtn, slot1)
	setActive(slot0.facebookLinkSign, slot1)
	setActive(slot0.facebookBtn, not slot1)
...
function slot0.editModeEnabled(slot0, slot1)
	...
	slot0.accountToggle:GetComponent(typeof(Toggle)).interactable = not slot1
...
function slot0.initExchangeCodePanel(slot0)
	setActive(slot0:findTF("nav/nav/exchange"), false)
...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0.facebookBtn, function ()
		pg.UIMgr.GetInstance():LoadingOn()
		LinkSocial(AIRI_PLATFORM_FACEBOOK)
	end)
	onButton(slot0, slot0.facebookUnlinkBtn, function ()
		pg.UIMgr.GetInstance():LoadingOn()
